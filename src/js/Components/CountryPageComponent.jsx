    ...
    return (
      <Layout>
            ...
            <Container>
              ...
              <Gallery
                ...
                items={this.state.places.map((place) => ({
                  original: `https://proterozoic-observe.000webhostapp.com/images/${this.state.nameEn}/${place.imageUrl}`,
                  thumbnail: `https://proterozoic-observe.000webhostapp.com/images/${this.state.nameEn}/${place.imageUrl}`,
        ...
        <Footer className='footer' style={{ zIndex: 9999 }}>
          <a
            href='https://github.com/SuzyGRBT'
            target='_blank'
            rel='noreferrer'
          ...
          <a
            href='https://github.com/conservativ007'
            target='_blank'
            rel='noreferrer'
            className='footer-item'
          >
          ...
          <a
            href='https://github.com/odil-abdulloyev'
            target='_blank'
            rel='noreferrer'
            className='footer-item'
          >
