...
const MainPage = (props) => {
  ...
  console.log(`language is ${props.lang}`);
  ...
  function handleChange(value) {
    dispatch({ type: 'LANG_CHANGE', payload: value });
  }
  ...
  useEffect(() => {
    countries = null;
    let url = `https://travel-app-be.herokuapp.com/countries?lang=${props.lang}`;
    loading = true;
    fetch(url)
      .then(res => res.json())
      .then(json => {
    ...
    <Layout>
      <Header className="header">
        ...
        <div className="header-section header-section--right">
          <Select defaultValue={props.lang} style={{ width: 120, margin: '1%' }} onChange={handleChange}>
